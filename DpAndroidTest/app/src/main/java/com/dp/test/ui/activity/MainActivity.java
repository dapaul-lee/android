    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.android_native_component:
                ...
                break;
            case R.id.java_system:
                switchToActivity(JavaSystemActivity.class);
                break;
            case R.id.android_system:
                switchToActivity(AndroidSystemActivity.class);
                break;
            case R.id.open_source_framework:
                switchToActivity(OpenSourceFrameworkActivity.class);
                break;
            ...
            case R.id.custom_view:
                ...
                break;
            case R.id.function:
                switchToActivity(FunctionActivity.class);
                break;
        }
    }
}
